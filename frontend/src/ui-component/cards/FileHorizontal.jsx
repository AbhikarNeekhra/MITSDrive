...
import { Avatar, Grid, Stack, Chip, Menu, MenuItem, Link } from '@mui/material';
...
const FileHorizontal = ({ key, file, callback, openFolder }) => {
      ...
      <div className="file-icon-card">
        ...
        <div className="file-details">
          <Link underline="hover" key="1" color="inherit">
            <h2 onClick={handleInfo}>{truncateFileName(file.name, 15)}</h2>
          </Link>
          <Link underline="hover" key="1" color="inherit"><p onClick={handleInfo} dangerouslySetInnerHTML={{
          ...
          <Link underline="hover" key="1" color="inherit"><p style={{ cursor: 'pointer' }} onClick={handleInfo}>{formatFileSize(file.size)}</p></Link >
        </div>
        <div className="share">
